...
-- NEED TO ACCOUNT FOR UNATTEMPTED ASSIGNMENTS
    ...
    IF EXISTS(SELECT * FROM HW4_Student WHERE HW4_Student.SID = sid) THEN
        ...
        SET @sql = CONCAT('WITH StudentScores AS (SELECT HW4_Student.SID AS SID, HW4_Student.LName AS LName, HW4_Student.FName AS FName, HW4_Student.Sec AS Sec, CAST(Assignments.Score AS NUMERIC (3,2)) AS Score, Assignments.AName AS AName
